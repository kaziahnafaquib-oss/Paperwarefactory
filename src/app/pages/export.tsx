...
export function ExportPage() {
  ...
  return (
    <div className="bg-[#fdfaf3] min-h-screen pt-32 md:pt-40 pb-20 font-['Poppins',sans-serif]">
      {/* Hero Section */}
      <section className="container mx-auto px-4 mb-32">
        <div className="bg-black rounded-[60px] p-12 md:p-24 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl space-y-10">
            ...
            <h1 className="text-[48px] md:text-[90px] font-black uppercase tracking-tighter leading-[0.85]">
            ...
            {/* Insights Grid */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-12 md:pt-20 border-t border-white/10">
              {[
                ...
                <motion.div 
                  ...
                  className="bg-white p-10 rounded-[50px] border border-black/5 space-y-3"
                >
                  <p className="text-[10px] font-black uppercase tracking-widest text-zinc-500">{stat.label}</p>
                  <div className="space-y-1">
                    <h4 className="text-xl md:text-2xl font-black uppercase tracking-tight text-[#fabf37]">{stat.value}</h4>
      ...
      <section className="container mx-auto px-4 mt-40 mb-40">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            { title: t('fsc_certified'), desc: t('fsc_desc') },
            { title: "ISO 9001:2015", desc: t('quality_index') },
            { title: "ISO 14001", desc: t('eco_vision') },
            { title: "SGS Verified", desc: t('precision') }
          ].map((cert, i) => (
            <div key={i} className="bg-white p-10 rounded-[50px] border-2 border-zinc-100 space-y-6 hover:border-black transition-all">
               <ShieldCheck className="size-12 text-[#fabf37]" />
               <div className="space-y-2">
                 <h4 className="text-lg font-black uppercase tracking-tight">{cert.title}</h4>
                 <p className="text-xs font-bold text-zinc-400 leading-relaxed">{cert.desc}</p>
               </div>
            </div>
          ))}
        </div>
           ...
           <div className="grid lg:grid-cols-12 gap-16 items-center">
              <div className="lg:col-span-7 space-y-12">
                 <div className="space-y-6">
                    <h2 className="text-5xl font-black uppercase tracking-tighter leading-none">{t('cost_optimization_engine')}</h2>
                    <p className="text-zinc-400 font-bold text-lg">{t('cost_optimization_desc')}</p>
                 </div>
              ...
              <div className="lg:col-span-5">
                 <div className="bg-[#fabf37] p-12 rounded-[50px] text-black space-y-8 shadow-2xl transform rotate-1">
                    ...
                    <h3 className="text-3xl font-black uppercase tracking-tighter leading-none">{t('start_global_journey')}</h3>
